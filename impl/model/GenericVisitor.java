...
public class GenericVisitor implements Swag.Visitor
{
  ...
  public void visitProg(Swag.Absyn.Prog prog)
  {
    /* Code For Prog Goes Here */
      try {
	  ((Swag.Absyn.ListTournament)prog.getClass().getFields()[0].get(prog)).accept(this);
      } catch (IllegalAccessException e) {
	  e.printStackTrace();
      }
      //if (prog.listtournament_ != null) {prog.listtournament_.accept(this);} // why wont this work????
      //      System.out.println(java.util.Arrays.toString(prog.getClass().getFields()));
      //      System.out.println(java.util.Arrays.toString(getClass().getFields()));
  }
  public void visitTournament(Swag.Absyn.Tournament tournament)
  {
    /* Code For Tournament Goes Here */
      System.out.println("This is tournament" + tournament.ident_);
