_Temporary disclaimer: Note that this was originally hosted (and still is) at [Bitbucket](http://bitbucket.org/aerivan/fopl-project). Hopefully all branches were up-to-date locally on my machine when I pushed to GitHub but I have not tested this (will do though)._
